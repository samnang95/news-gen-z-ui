        ...
        <form onSubmit={handleLogin} className="bg-zinc-900/60 backdrop-blur-2xl border border-white/10 p-8 rounded-[2.5rem] shadow-[0_0_50px_rgba(168,85,247,0.15)] flex flex-col gap-6">
          ...
          <div>
            ...
            <input 
              ...
              className="w-full bg-black/50 border border-white/5 rounded-[1.5rem] px-6 py-4 text-white focus:outline-none focus:border-purple-500/50 focus:ring-1 focus:ring-purple-500/50 transition-all placeholder:text-zinc-600 hover:border-white/10 shadow-inner"
          ...
          <button 
            type="submit"
            className="w-full bg-linear-to-r from-purple-600 to-blue-600 text-white font-bold py-4 rounded-[1.5rem] mt-4 hover:opacity-90 hover:scale-[1.02] active:scale-95 transition-all shadow-[0_0_20px_rgba(168,85,247,0.4)] hover:shadow-[0_0_30px_rgba(168,85,247,0.6)]"
          >
            Sign In
          </button>
